...
public class LiulanjiluView extends LiulanjiluEntity implements Serializable {
	...
	public LiulanjiluView() {

	}

	public LiulanjiluView(LiulanjiluEntity liulanjiluEntity) {
		try {
			BeanUtils.copyProperties(this, liulanjiluEntity);
